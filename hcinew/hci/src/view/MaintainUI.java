...
public class MaintainUI extends JFrame {
	...
	public MaintainUI() {
		...
		setIconImage(Toolkit.getDefaultToolkit()
				.getImage("C:\\Users\\db2admin\\eclipse-workspace\\hci\\src\\view\\Images\\10.jpg"));
		background = new JLabel();
		background
				.setIcon(new ImageIcon("C:\\Users\\db2admin\\eclipse-workspace\\hci\\src\\view\\Images\\10.jpg"));
		background.setBounds(0, 0, 567, 366);
